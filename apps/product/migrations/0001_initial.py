...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='form',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.form'),
        ),
        migrations.AddField(
            model_name='form',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='forms', to='product.formcategory', verbose_name='Категория'),
        ),
        migrations.CreateModel(
            name='FormColor',
            fields=[
                ...
                ('name', models.CharField(max_length=50, verbose_name='Цвет')),
                ('hex_code', colorfield.fields.ColorField(default='#FFFFFF', image_field=None, max_length=25, samples=None, verbose_name='HEX Код')),
                ('form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.form')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_ru', models.CharField(max_length=255, null=True, verbose_name='Название команды')),
                ('name_en', models.CharField(max_length=255, null=True, verbose_name='Название команды')),
                ('name_ky', models.CharField(max_length=255, null=True, verbose_name='Название команды')),
                ('name_kk', models.CharField(max_length=255, null=True, verbose_name='Название команды')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.formvariant')),
            ],
        ),
        migrations.CreateModel(
            name='Ornament',
        ...
        migrations.AddField(
            ...
            name='ornament',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.ornament', verbose_name='Орнамент'),
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
